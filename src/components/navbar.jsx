      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            ...
            <Link to="/timer" className="pages font-bold text-xl text-blue-600 ml-6 dark:text-blue-400 mr-8 hidden sm:inline-block">
              <img
                src={timer}
                alt="Timer"
                className="h-9 w-55"
            ...
            <Link to="/WorldClock" className="pages font-bold text-xl text-blue-600 dark:text-blue-400 hidden sm:inline-block">
              <img
                src={worldClock}
                alt="World Clock"
                className="h-9 w-55"
        ...
        {menuOpen && (
          <div className="sm:hidden bg-white dark:bg-gray-800 py-4">
            <Link to="/timer" className="pages font-bold text-xl text-blue-600 dark:text-blue-400 block mb-2 flex items-center">
              <img src={timer} alt="Timer" className="h-9 w-55" />
              <span className="ml-2">Timer</span>
            </Link>
            <Link to="/WorldClock" className="pages font-bold text-xl text-blue-600 dark:text-blue-400 block mb-2 flex items-center">
